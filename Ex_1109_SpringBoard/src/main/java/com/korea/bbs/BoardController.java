...
public class BoardController {
	...
	public String modify_form(int idx, String subject, String name, String content, int page) {
		return Common.VIEW_PATH + "modify_form.jsp?idx=" + idx + "&subject=" + subject + "&name=" + name + "&content=" + content + "&page=" + page;
	...
	public String modify(int idx, String subject, String name, String content, String pwd, int page) {
		BoardVO basevo = board_dao.selectOne(idx);
		...
		int res = board_dao.board_update(basevo);
